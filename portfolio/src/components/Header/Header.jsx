...
const Nav = () => {
    ...
    const content = <>
        <div className="block absolute top-16 w-full h-screen left-0 right-0 bg-smallTextColor text-white dark:bg-white  font-[700]  dark:text-smallTextColor z-20 transition">
